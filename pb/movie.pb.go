...
func (m *SearchMovieResponse) GetTitle() string {
	if m != nil {
		return m.Title
	}
	return ""
...
func (m *SearchMovieResponse) GetYear() string {
	if m != nil {
		return m.Year
	}
	return ""
...
func (m *SearchMovieResponse) GetImdbID() string {
	if m != nil {
		return m.ImdbID
	}
	return ""
...
func (m *SearchMovieResponse) GetType() string {
	if m != nil {
		return m.Type
	}
	return ""
...
func (m *SearchMovieResponse) GetPoster() string {
	if m != nil {
		return m.Poster
	}
	return ""
...
var fileDescriptor_fde087a4194eda75 = []byte{
	...
	,
}
...
func (c *movieClient) SearchMovie(ctx context.Context, in *SearchMovieRequest, opts ...grpc.CallOption) (*SearchMovieResponse, error) {
	out := new(SearchMovieResponse)
	err := c.cc.Invoke(ctx, "/pb.Movie/SearchMovie", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMovieServer) SearchMovie(ctx context.Context, req *SearchMovieRequest) (*SearchMovieResponse, error) {
...
func _Movie_SearchMovie_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieServer).SearchMovie(ctx, req.(*SearchMovieRequest))
	}
